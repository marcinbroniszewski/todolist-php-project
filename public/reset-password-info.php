...
if (empty($_SESSION['reset_pwd_success'])) {
...
?>
    <main class="d-flex flex-column justify-content-center align-items-center sign-section">
        <h1 class="sign-h1 mt-5 mb-3 px-4">Hasło zostało zmienione</h1>
        <p class="switch-paragraph mb-5">Kliknij <a class="switch-link" href="login.php">tutaj</a>, aby się zalogować</p>
